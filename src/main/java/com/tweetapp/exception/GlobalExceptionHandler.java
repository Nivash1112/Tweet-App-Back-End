...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleUserExistsExceptions(final UserAlreadyExists ex, final WebRequest request) {
    ...
    public ResponseEntity<Object> handlePasswordExceptions(final DetailsMisMatchException ex, final WebRequest request) {
        final ExceptionDetails errorDetails = new ExceptionDetails(
