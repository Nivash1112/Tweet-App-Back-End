...
public class UserTweetController {
    ...
    public ResponseEntity<?> getAllTweets() {
        ...
        try {
            ...
            return new ResponseEntity<>(new ErrorResponse(TweetConstants.APP_EXCEPTION),
    ...
    public ResponseEntity<?> getUserTweets(@PathVariable("username") String username,
        ...
        try {
            ...
            return new ResponseEntity<>(new ErrorResponse("Invalid user name"), HttpStatus.UNPROCESSABLE_ENTITY);
        } catch (Exception e) {
            return new ResponseEntity<>(new ErrorResponse(TweetConstants.APP_EXCEPTION), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<?> updateTweet(@PathVariable("username") String userId,
        ...
        try {
            ...
            return new ResponseEntity<>(new ErrorResponse(TweetConstants.TWEET_ISSUE), HttpStatus.NOT_FOUND);
        } catch (Exception e) {
            return new ResponseEntity<>(new ErrorResponse(TweetConstants.APP_EXCEPTION), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
